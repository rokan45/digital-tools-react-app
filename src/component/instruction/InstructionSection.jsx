        ...
        <div className='mx-auto mt-10 px-5'>
            ...
            <div className='mt-5 grid grid-cols-1 gap-4 py-10 px-15 lg:grid-cols-3'>
                <div className='flex flex-col items-center p-5 relative text-center shadow-lg rounded-2xl'>
                    ...
                    <p className='text-sm text-gray-500 mt-3 leading-relaxed max-w-55'>Sign up for free in seconds. No credit card required to get started.</p>
                </div>
                <div className='flex flex-col items-center py-5 relative text-center shadow-lg rounded-2xl'>
                    ...
                    <p className='text-sm text-gray-500 mt-3 leading-relaxed max-w-55'>Browse our catalog and select the tools that fit your needs.</p>
                </div>
                <div className='flex flex-col items-center py-5 relative text-center shadow-lg rounded-2xl'>
                    ...
                    <p className='text-sm text-gray-500 mt-3 leading-relaxed max-w-55'>Download and start using your premium tools immediately.</p>
                </div>
